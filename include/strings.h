...
// option menu texts
extern const u8 gText_OptionMenuTitle[];
extern const u8 gText_OptionMenuDifficulty[];
extern const u8 gText_OptionMenuBattleScene[];
extern const u8 gText_OptionMenuExpShare[];
extern const u8 gText_OptionMenuMachoBrace[];
extern const u8 gText_OptionMenuEverstone[];
extern const u8 gText_OptionMenuFrameType[];
extern const u8 gText_OptionMenuCancel[];
extern const u8 gText_OptionMenuEasy[];
extern const u8 gText_OptionMenuMed[];
extern const u8 gText_OptionMenuHard[];
extern const u8 gText_OptionMenuOff[];
extern const u8 gText_OptionMenuOn[];
extern const u8 gText_OptionMenuNumber[];
...
extern const u8 gText_BirchAdventure[];
extern const u8 gText_BirchChallenge[];
...
extern const u8 gText_BerryJuice20[];
extern const u8 gText_HPUp100[];
extern const u8 gText_Protein100[];
extern const u8 gText_Iron100[];
extern const u8 gText_Calcium100[];
extern const u8 gText_Zinc100[];
extern const u8 gText_Carbos100[];
extern const u8 gText_PPUp300[];
extern const u8 gText_PPMax3000[];
...
extern const u8 gText_LarvitarAndPrice[];
extern const u8 gText_BagonAndPrice[];
extern const u8 gText_BeldumAndPrice[];
extern const u8 gText_GibleAndPrice[];
extern const u8 gText_DeinoAndPrice[];
extern const u8 gText_GoomyAndPrice[];
extern const u8 gText_JangmoOAndPrice[];
extern const u8 gText_DreepyAndPrice[];
extern const u8 gText_FrigibaxAndPrice[];
extern const u8 gText_GimmighoulCoinAndPrice[];
extern const u8 gText_LeekAndPrice[];
extern const u8 gText_LightBallAndPrice[];
extern const u8 gText_LuckyPunchAndPrice[];
extern const u8 gText_MetalPowderAndPrice[];
extern const u8 gText_QuickPowderAndPrice[];
extern const u8 gText_ThickClubAndPrice[];
extern const u8 gText_DragonScaleAndPrice[];
extern const u8 gText_PrismScaleAndPrice[];
extern const u8 gText_DeepSeaScaleAndPrice[];
extern const u8 gText_DeepSeaToothAndPrice[];
extern const u8 gText_LeadersCrestAndPrice[];
extern const u8 gText_AmuletCoinAndPrice[];
extern const u8 gText_ExpShareAndPrice[];
extern const u8 gText_LuckyEggAndPrice[];
extern const u8 gText_SweetAppleAndPrice[];
extern const u8 gText_SyrupyAppleAndPrice[];
extern const u8 gText_TartAppleAndPrice[];
extern const u8 gText_CrackedPotAndPrice[];
extern const u8 gText_UnremarkableTeacupAndPrice[];
extern const u8 gText_AuspiciousArmorAndPrice[];
extern const u8 gText_MaliciousArmorAndPrice[];
extern const u8 gText_GalaricaCuffAndPrice[];
extern const u8 gText_GalaricaWreathAndPrice[];
extern const u8 gText_BlackAuguriteAndPrice[];
extern const u8 gText_LinkingCordAndPrice[];
extern const u8 gText_MetalAlloyAndPrice[];
extern const u8 gText_PeatBlockAndPrice[];
extern const u8 gText_ChippedPotAndPrice[];
extern const u8 gText_MasterpieceTeacupAndPrice[];
extern const u8 gText_BerrySweetAndPrice[];
extern const u8 gText_CloverSweetAndPrice[];
extern const u8 gText_FlowerSweetAndPrice[];
extern const u8 gText_LoveSweetAndPrice[];
extern const u8 gText_RibbonSweetAndPrice[];
extern const u8 gText_StarSweetAndPrice[];
extern const u8 gText_StrawberrySweetAndPrice[];
extern const u8 gText_UpgradeAndPrice[];
extern const u8 gText_DubiousDiscAndPrice[];
extern const u8 gText_ElectirizerAndPrice[];
extern const u8 gText_MagmarizerAndPrice[];
extern const u8 gText_ProtectorAndPrice[];
extern const u8 gText_ReaperClothAndPrice[];
extern const u8 gText_SachetAndPrice[];
extern const u8 gText_WhippedDreamAndPrice[];

// Cutting Hunter
extern const u8 gText_PinkApricorn[];
extern const u8 gText_RedApricorn[];
extern const u8 gText_GreenApricorn[];
extern const u8 gText_WhiteApricorn[];
extern const u8 gText_BlueApricorn[];
extern const u8 gText_YellowApricorn[];
extern const u8 gText_BlackApricorn[];

// Smashing Hunter
extern const u8 gText_RareBone[];
extern const u8 gText_OddBone[];
...
extern const u8 gText_PrettyFeather[];

// Surfing Hunter
extern const u8 gText_ShoalShell[];
extern const u8 gText_ShoalSalt[];
...
extern const u8 gText_OvalStone[];
...
extern const u8 gText_Dawn_Stone[];
