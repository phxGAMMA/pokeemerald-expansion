...
#define P_FLAG_FORCE_SHINY      FLAG_UNUSED_0x271 // If this flag is set, all wild and gift Pokémon will forced into being Shiny.
#define P_FLAG_FORCE_NO_SHINY   FLAG_UNUSED_0x272 // If this flag is set, all wild and gift Pokémon will forced into NOT being Shiny.
