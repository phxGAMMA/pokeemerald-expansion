...
#define B_FLAG_AI_VS_AI_BATTLE      FLAG_UNUSED_0x269 // If this flag is set, the player's mons will be controlled by the ai next battles.
#define B_FLAG_DYNAMAX_BATTLE       FLAG_UNUSED_0x26A // If this flag is set, the ability to Dynamax in battle is enabled for all trainers.
...
#define B_VAR_WILD_AI_FLAGS         VAR_UNUSED_0x40F8 // If not 0, you can use this var to add to default wild AI flags. NOT usable with flags above (1 << 15)

// Sky Battles
#define B_FLAG_SKY_BATTLE           FLAG_UNUSED_0x26B // If this flag has a value, the player will be able to engage in scripted Sky Battles.
