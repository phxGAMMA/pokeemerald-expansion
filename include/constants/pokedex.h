...
enum {
    ...
    NATIONAL_DEX_YUKIMI_BOTAMON,
    // Training II
    NATIONAL_DEX_KOROMON,
    NATIONAL_DEX_TSUNOMON,
    NATIONAL_DEX_DEMI_VEEMON,
    ...
    NATIONAL_DEX_EX_VEEMON,
    NATIONAL_DEX_STINGMON,
    NATIONAL_DEX_GROWLMON,
    NATIONAL_DEX_BIRDRAMON,
    NATIONAL_DEX_TOGEMON,
    NATIONAL_DEX_AQUILAMON,
    NATIONAL_DEX_KYUBIMON,
    NATIONAL_DEX_KABUTERIMON,
    NATIONAL_DEX_IKAKKUMON,
    NATIONAL_DEX_ANKYLOMON,
    NATIONAL_DEX_GARGOMON,
    NATIONAL_DEX_ANGEMON,
    NATIONAL_DEX_GATOMON,
    // Ultimate
    NATIONAL_DEX_METAL_GREYMON,
    NATIONAL_DEX_WERE_GARURUMON,
    NATIONAL_DEX_PAILDRAMON,
    NATIONAL_DEX_WAR_GROWLMON,
    NATIONAL_DEX_GARUDAMON,
    NATIONAL_DEX_LILYMON,
    NATIONAL_DEX_SILPHYMON,
    NATIONAL_DEX_TAOMON,
    NATIONAL_DEX_MEGA_KABUTERIMON,
    NATIONAL_DEX_ZUDOMON,
    NATIONAL_DEX_SHAKKOUMON,
    NATIONAL_DEX_RAPIDMON,
    NATIONAL_DEX_MAGNA_ANGEMON,
    NATIONAL_DEX_ANGEWOMON,
    // Mega I
    NATIONAL_DEX_WAR_GREYMON,
    NATIONAL_DEX_METAL_GARURUMON,
    NATIONAL_DEX_DRAGON_IMPERIALDRAMON,
    NATIONAL_DEX_GALLANTMON,
    NATIONAL_DEX_SAKUYAMON,
    NATIONAL_DEX_MEGA_GARGOMON,
    NATIONAL_DEX_SERAPHIMON,
    NATIONAL_DEX_MAGNADRAMON,
    // Mega II
    NATIONAL_DEX_OMNIMON,
    NATIONAL_DEX_FIGHTER_IMPERIALDRAMON,
    NATIONAL_DEX_CRIMSON_GALLANTMON,
    // Mega III
    NATIONAL_DEX_PALADIN_IMPERIALDRAMON,
};
...
#if D_STG_MEGA_III_DIGIMON == TRUE
    #define NATIONAL_DEX_COUNT  NATIONAL_DEX_PALADIN_IMPERIALDRAMON
#elif D_STG_MEGA_II_DIGIMON == TRUE
    #define NATIONAL_DEX_COUNT  NATIONAL_DEX_FIGHTER_IMPERIALDRAMON
#elif D_STG_MEGA_I_DIGIMON == TRUE
    #define NATIONAL_DEX_COUNT  NATIONAL_DEX_MAGNADRAMON
#elif D_STG_ULTIMATE_DIGIMON == TRUE
    #define NATIONAL_DEX_COUNT  NATIONAL_DEX_ANGEWOMON
#elif D_STG_CHAMPION_DIGIMON == TRUE
    #define NATIONAL_DEX_COUNT  NATIONAL_DEX_GATOMON
#elif D_STG_ROOKIE_DIGIMON == TRUE
    #define NATIONAL_DEX_COUNT  NATIONAL_DEX_SALAMON
#elif D_STG_TRAINING_II_DIGIMON == TRUE
    #define NATIONAL_DEX_COUNT  NATIONAL_DEX_NYAROMON
#elif D_STG_TRAINING_I_DIGIMON == TRUE
    #define NATIONAL_DEX_COUNT  NATIONAL_DEX_YUKIMI_BOTAMON
