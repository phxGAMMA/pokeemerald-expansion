...
struct SaveBlock2
{
    ...
    /*0x13*/ u8 optionsDifficultyMode;     // OPTIONS_DIFFICULTY_[EASY/MED/HARD]
    /*0x14*/ u16 optionsTextSpeed:3;       // OPTIONS_TXT_SPEED_[SLOW/MID/FAST]
             u16 optionsWindowFrameType:5; // OPTIONS_FRAME_[1-20]
             u16 optionsSound:1;           // OPTIONS_SOUND_[MONO/STEREO]
             u16 optionsEvoSceneOn:1;      // OPTIONS_EVO_SCENE_[ON/OFF]
             u16 optionsBattleSceneOn:1;   // OPTIONS_BAT_SCENE_[ON/OFF]
             u16 optionsExpShareOn:1;      // OPTIONS_EXP_SHARE_[ON/OFF]
