...
struct SaveBlock2
{
    ...
    /*0x13*/ u8 regionMapZoom:1;
    /*0x14*/ u16 optionsDifficultyMode:3;  // OPTIONS_DIFFICULTY   [EASY/MED/HARD]
             u16 optionsBattleSceneOn:1;   // OPTIONS_BATTLE_SCENE [OFF/ON]
             u16 optionsExpShareOn:1;      // OPTIONS_EXP_SHARE    [OFF/ON]
             u16 optionsMachoBraceOn:1;    // OPTIONS_MACHO_BRACE  [OFF/ON]
             u16 optionsEverstoneOn:1;     // OPTIONS_EVERSTONE    [OFF/ON]
             u16 optionsWindowFrameType:5; // OPTIONS_FRAME_STYLE  [1 - 20]
             //u16 padding1:4;
             //u16 padding2;
