...
static const struct TrainerMon sParty_GruntAquaHideout1[] = {
    {
    .moves = {MOVE_THUNDER_FANG, MOVE_CRUNCH, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_GruntAquaHideout2[] = {
    {
    .moves = {MOVE_KNOCK_OFF, MOVE_ICE_SHARD, MOVE_NONE, MOVE_NONE},
    ...
    {
    .moves = {MOVE_NIGHT_SLASH, MOVE_AIR_CUTTER, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_GruntAquaHideout3[] = {
    {
    .moves = {MOVE_STEEL_WING, MOVE_AIR_SLASH, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_GruntAquaHideout4[] = {
    {
    .moves = {MOVE_ZAP_CANNON, MOVE_EXPLOSION, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_GruntSeafloorCavern1[] = {
    {
    .moves = {MOVE_ROCK_SLIDE, MOVE_WATERFALL, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_GruntSeafloorCavern3[] = {
    {
    .moves = {MOVE_ICICLE_CRASH, MOVE_CHILLING_WATER, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_ShellyPetalburgWoods[] = {
    {
...
static const struct TrainerMon sParty_GruntSeafloorCavern4[] = {
    {
    .moves = {MOVE_ICE_BEAM, MOVE_OMINOUS_WIND, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_MattRusturfTunnel[] = {
    {
    .moves = {MOVE_BUBBLE, MOVE_VISE_GRIP, MOVE_HARDEN, MOVE_NONE},
...
static const struct TrainerMon sParty_GruntWeatherInstitute1[] = {
    {
    .moves = {MOVE_SCALD, MOVE_MAGNITUDE, MOVE_NONE, MOVE_NONE},
    ...
    {
    .moves = {MOVE_MUDDY_WATER, MOVE_MUD_BOMB, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_GruntWeatherInstitute2[] = {
    {
    .moves = {MOVE_BITE, MOVE_SUPER_FANG, MOVE_NONE, MOVE_NONE},
    ...
    {
    .moves = {MOVE_RAZOR_SHELL, MOVE_BRICK_BREAK, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_GruntWeatherInstitute3[] = {
    {
    .moves = {MOVE_NIGHT_SHADE, MOVE_PAIN_SPLIT, MOVE_NONE, MOVE_NONE},
    ...
    {
    .moves = {MOVE_THUNDER_PUNCH, MOVE_BODY_SLAM, MOVE_NONE, MOVE_NONE},
    ...
    {
    .moves = {MOVE_WHIRLPOOL, MOVE_CIRCLE_THROW, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_ShellyMuseum[] = {
    {
    .moves = {MOVE_FLAIL, MOVE_NONE, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_FEEBAS,
    .heldItem = ITEM_BRIGHT_POWDER,
    ...
    {
    .moves = {MOVE_ASTONISH, MOVE_ANCIENT_POWER, MOVE_DISABLE, MOVE_NONE},
...
static const struct TrainerMon sParty_MattMuseum[] = {
    {
    .moves = {MOVE_BUBBLE_BEAM, MOVE_DOUBLE_HIT, MOVE_PROTECT, MOVE_NONE},
    .species = SPECIES_CORPHISH,
    .heldItem = ITEM_BRIGHT_POWDER,
    .ability = ABILITY_ADAPTABILITY,
    .lvl = 17,
    ...
    {
    .moves = {MOVE_PIN_MISSILE, MOVE_BARB_BARRAGE, MOVE_SPIKES, MOVE_NONE},
...
static const struct TrainerMon sParty_GruntSpaceCenter1[] = {
    {
    .moves = {MOVE_EXPLOSION, MOVE_EARTHQUAKE, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_GruntMtPyre1[] = {
    {
    .moves = {MOVE_POISON_FANG, MOVE_AIR_CUTTER, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_GruntMtPyre2[] = {
    {
    .moves = {MOVE_RAZOR_SHELL, MOVE_ICE_SHARD, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_GruntMtPyre3[] = {
    {
    .moves = {MOVE_SHADOW_SNEAK, MOVE_DESTINY_BOND, MOVE_NONE, MOVE_NONE},
    ...
    {
    .moves = {MOVE_AQUA_JET, MOVE_CRUNCH, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_GruntWeatherInstitute4[] = {
    {
    .moves = {MOVE_BRINE, MOVE_DUAL_WINGBEAT, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_GruntAquaHideout5[] = {
    {
    .moves = {MOVE_ELECTRO_BALL, MOVE_SELF_DESTRUCT, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_GruntAquaHideout6[] = {
    {
    .moves = {MOVE_DISCHARGE, MOVE_PSYCHIC_NOISE, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_MattAquaHideout[] = {
    {
    .moves = {MOVE_DARK_PULSE, MOVE_POISON_JAB, MOVE_WATER_PULSE, MOVE_SPIKES},
    ...
    {
    .moves = {MOVE_RAZOR_SHELL, MOVE_KNOCK_OFF, MOVE_DOUBLE_HIT, MOVE_TAUNT},
...
static const struct TrainerMon sParty_ShellyWeatherInstitute[] = {
    {
    .moves = {MOVE_HEX, MOVE_ANCIENT_POWER, MOVE_ICE_BEAM, MOVE_STRENGTH_SAP},
    .species = SPECIES_CORSOLA_GALARIAN,
    .heldItem = ITEM_BRIGHT_POWDER,
    .ability = ABILITY_CURSED_BODY,
    .lvl = 32,
    ...
    {
    .moves = {MOVE_WATER_PULSE, MOVE_DRAGON_TAIL, MOVE_DISARMING_VOICE, MOVE_RECOVER},
...
static const struct TrainerMon sParty_ShellySeafloorCavern[] = {
    {
    .moves = {MOVE_SHADOW_BALL, MOVE_ANCIENT_POWER, MOVE_ICE_BEAM, MOVE_STRENGTH_SAP},
    ...
    {
    .moves = {MOVE_AQUA_TAIL, MOVE_DRAGON_TAIL, MOVE_IRON_TAIL, MOVE_RECOVER},
    .species = SPECIES_MILOTIC,
    .heldItem = ITEM_BRIGHT_POWDER,
    .ability = ABILITY_CUTE_CHARM,
    .lvl = 44,
...
static const struct TrainerMon sParty_Archie[] = {
    {
    .moves = {MOVE_GUNK_SHOT, MOVE_DARK_PULSE, MOVE_SHADOW_BALL, MOVE_EXPLOSION},
    .species = SPECIES_MUK,
    .heldItem = ITEM_BRIGHT_POWDER,
    ...
    {
    .moves = {MOVE_THUNDER, MOVE_FIRE_PUNCH, MOVE_LOW_KICK, MOVE_THUNDER_WAVE},
    ...
    {
    .moves = {MOVE_NIGHT_SLASH, MOVE_TAKE_DOWN, MOVE_CROSS_CHOP, MOVE_OBSTRUCT},
...
static const struct TrainerMon sParty_GabbyAndTy1[] = {
    {
    .moves = {MOVE_SPARK, MOVE_PROTECT, MOVE_NONE, MOVE_NONE},
    ...
    {
    .moves = {MOVE_ROUND, MOVE_SUBSTITUTE, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_GabbyAndTy2[] = {
    {
    .moves = {MOVE_THUNDERBOLT, MOVE_SIGNAL_BEAM, MOVE_PROTECT, MOVE_NONE},
    .species = SPECIES_MAGNETON,
    .heldItem = ITEM_METRONOME,
    .ability = ABILITY_MAGNET_PULL,
    .lvl = 32,
    ...
    {
    .moves = {MOVE_UPROAR, MOVE_EXTRASENSORY, MOVE_SUBSTITUTE, MOVE_NONE},
...
static const struct TrainerMon sParty_GabbyAndTy3[] = {
    {
    .moves = {MOVE_THUNDER, MOVE_MAGNET_BOMB, MOVE_SIGNAL_BEAM, MOVE_PROTECT},
    ...
    {
    .moves = {MOVE_HYPER_VOICE, MOVE_SECRET_POWER, MOVE_EXTRASENSORY, MOVE_SUBSTITUTE},
...
static const struct TrainerMon sParty_GabbyAndTy4[] = {
    {
    .moves = {MOVE_BIDE, MOVE_PROTECT, MOVE_NONE, MOVE_NONE},
    ...
    {
    .moves = {MOVE_CONFUSION, MOVE_SUBSTITUTE, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_GabbyAndTy5[] = {
    {
    .moves = {MOVE_TAKE_DOWN, MOVE_ELECTRIC_TERRAIN, MOVE_PROTECT, MOVE_NONE},
    .species = SPECIES_GRAVELER_ALOLAN,
    .heldItem = ITEM_METRONOME,
    .ability = ABILITY_GALVANIZE,
    .lvl = 39,
    ...
    {
    .moves = {MOVE_PSYBEAM, MOVE_SHOCK_WAVE, MOVE_SUBSTITUTE, MOVE_NONE},
...
static const struct TrainerMon sParty_GabbyAndTy6[] = {
    {
    .moves = {MOVE_DOUBLE_EDGE, MOVE_METEOR_BEAM, MOVE_ELECTRIC_TERRAIN, MOVE_PROTECT},
    ...
    {
    .moves = {MOVE_PSYSHOCK, MOVE_TRIPLE_AXEL, MOVE_SHOCK_WAVE, MOVE_SUBSTITUTE},
...
static const struct TrainerMon sParty_Simon[] = {
    {
    .moves = {MOVE_WATER_GUN, MOVE_MUD_SLAP, MOVE_NONE, MOVE_NONE},
    ...
    {
    .moves = {MOVE_WHIRLPOOL, MOVE_MUD_SHOT, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Randall[] = {
    {
    .moves = {MOVE_FOUL_PLAY, MOVE_NONE, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Parker[] = {
    {
    .moves = {MOVE_BIDE, MOVE_ACROBATICS, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_George[] = {
    {
    .moves = {MOVE_LAST_RESORT, MOVE_NONE, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Berke[] = {
    {
    .moves = {MOVE_HORN_DRILL, MOVE_STOMPING_TANTRUM, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Vincent[] = {
    {
    .moves = {MOVE_LIQUIDATION, MOVE_PERISH_SONG, MOVE_NONE, MOVE_NONE},
    ...
    {
    .moves = {MOVE_DIVE, MOVE_LEECH_SEED, MOVE_NONE, MOVE_NONE},
    ...
    {
    .moves = {MOVE_BUG_BITE, MOVE_GIGA_DRAIN, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Leroy[] = {
    {
    .moves = {MOVE_ICE_BEAM, MOVE_AURORA_VEIL, MOVE_NONE, MOVE_NONE},
    ...
    {
    .moves = {MOVE_BLIZZARD, MOVE_EARTHQUAKE, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Mary[] = {
    {
    .moves = {MOVE_FEINT_ATTACK, MOVE_DOUBLE_TEAM, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Alexia[] = {
    {
    .moves = {MOVE_RETURN, MOVE_PROTECT, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Jody[] = {
    {
    .moves = {MOVE_STOMP, MOVE_MILK_DRINK, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Keira[] = {
    {
    .moves = {MOVE_INCINERATE, MOVE_GRUDGE, MOVE_NONE, MOVE_NONE},
    ...
    {
    .moves = {MOVE_FLARE_BLITZ, MOVE_SCORCHING_SANDS, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Patricia[] = {
    {
    .moves = {MOVE_DOUBLE_EDGE, MOVE_MOONLIGHT, MOVE_NONE, MOVE_NONE},
    ...
    {
    .moves = {MOVE_SHADOW_PUNCH, MOVE_GRUDGE, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Daphne[] = {
    {
    .moves = {MOVE_AVALANCHE, MOVE_BRAVE_BIRD, MOVE_NONE, MOVE_NONE},
    ...
    {
    .moves = {MOVE_ICE_PUNCH, MOVE_ZEN_HEADBUTT, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_MR_RIME,
...
static const struct TrainerMon sParty_GruntSpaceCenter2[] = {
    {
    .moves = {MOVE_TAUNT, MOVE_SPITE, MOVE_NONE, MOVE_NONE},
    ...
    {
    .moves = {MOVE_EXPLOSION, MOVE_SUPERCELL_SLAM, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_GOLEM_ALOLAN,
    .heldItem = ITEM_RAZOR_FANG,
    .ability = ABILITY_GALVANIZE,
    .lvl = 41,
    ...
    {
    .moves = {MOVE_GYRO_BALL, MOVE_EXPLOSION, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Brianna[] = {
    {
    .moves = {MOVE_SCALD, MOVE_DREAM_EATER, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Connie[] = {
    {
    .moves = {MOVE_BULLET_SEED, MOVE_RAIN_DANCE, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_LUDICOLO,
...
static const struct TrainerMon sParty_Bridget[] = {
    {
    .moves = {MOVE_BRINE, MOVE_HYPNOSIS, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Olivia[] = {
    {
    .moves = {MOVE_MUDDY_WATER, MOVE_RAIN_DANCE, MOVE_NONE, MOVE_NONE},
    ...
    {
    .moves = {MOVE_DIVE, MOVE_COIL, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Tiffany[] = {
    {
    .moves = {MOVE_RAZOR_SHELL, MOVE_NONE, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_KINGLER,
    .heldItem = ITEM_CHOICE_BAND,
...
static const struct TrainerMon sParty_GruntMtChimney1[] = {
    {
    .moves = {MOVE_INCINERATE, MOVE_BULLDOZE, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Takao[] = {
    {
    .moves = {MOVE_KARATE_CHOP, MOVE_FURY_SWIPES, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Yuji[] = {
    {
    .moves = {MOVE_POWER_UP_PUNCH, MOVE_SUCKER_PUNCH, MOVE_NONE, MOVE_NONE},
    ...
    {
    .moves = {MOVE_REVENGE, MOVE_SMACK_DOWN, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Kirk[] = {
    {
    .moves = {MOVE_SHOCK_WAVE, MOVE_HYPER_VOICE, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_WHISMUR,
    .heldItem = ITEM_METRONOME,
    .ability = ABILITY_RATTLED,
    .lvl = 17,
...
static const struct TrainerMon sParty_GruntAquaHideout7[] = {
    {
    .moves = {MOVE_FLIP_TURN, MOVE_VOLT_SWITCH, MOVE_NONE, MOVE_NONE},
    ...
    {
    .moves = {MOVE_AVALANCHE, MOVE_MIRROR_COAT, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_MR_RIME,
    .heldItem = ITEM_BRIGHT_POWDER,
    .ability = ABILITY_TANGLED_FEET,
    .lvl = 37,
...
static const struct TrainerMon sParty_GruntAquaHideout8[] = {
    {
    .moves = {MOVE_WILD_CHARGE, MOVE_ELECTRIC_TERRAIN, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Shawn[] = {
    {
    .moves = {MOVE_ELECTRO_BALL, MOVE_MAGNET_RISE, MOVE_NONE, MOVE_NONE},
    ...
    {
    .moves = {MOVE_GYRO_BALL, MOVE_MAGNET_RISE, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_MAGNEMITE,
...
static const struct TrainerMon sParty_Cole[] = {
    {
    .moves = {MOVE_HEAT_WAVE, MOVE_SUBSTITUTE, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Jeff[] = {
    {
    .moves = {MOVE_FIRE_FANG, MOVE_REVERSAL, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_GROWLITHE,
    .heldItem = ITEM_RAZOR_FANG,
    .ability = ABILITY_INTIMIDATE,
    .lvl = 22,
...
static const struct TrainerMon sParty_Axle[] = {
    {
    .moves = {MOVE_SELF_DESTRUCT, MOVE_WILL_O_WISP, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Jace[] = {
    {
    .moves = {MOVE_TAKE_DOWN, MOVE_SCORCHING_SANDS, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Justin[] = {
    {
    .moves = {MOVE_DIZZY_PUNCH, MOVE_DYNAMIC_PUNCH, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Preston[] = {
    {
    .moves = {MOVE_EXPANDING_FORCE, MOVE_PSYCHIC_TERRAIN, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Virgil[] = {
    {
    .moves = {MOVE_SURF, MOVE_PSYCHIC, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Blake[] = {
    {
    .moves = {MOVE_FUTURE_SIGHT, MOVE_HYPER_VOICE, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Joshua[] = {
    {
    .moves = {MOVE_FLARE_BLITZ, MOVE_MORNING_SUN, MOVE_NONE, MOVE_NONE},
    ...
    {
    .moves = {MOVE_SHADOW_BALL, MOVE_DESTINY_BOND, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Samantha[] = {
    {
    .moves = {MOVE_FUTURE_SIGHT, MOVE_DAZZLING_GLEAM, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Alexis[] = {
    {
    .moves = {MOVE_OMINOUS_WIND, MOVE_GRUDGE, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_MISDREAVUS,
    .heldItem = ITEM_SPELL_TAG,
    .ability = ABILITY_LEVITATE,
    .lvl = 37,
    ...
    {
    .moves = {MOVE_MOONBLAST, MOVE_HEAL_PULSE, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_GARDEVOIR,
    .heldItem = ITEM_LIFE_ORB,
    .ability = ABILITY_SYNCHRONIZE,
    .lvl = 37,
...
static const struct TrainerMon sParty_Sidney[] = {
    {
    .moves = {MOVE_SNARL, MOVE_PLAY_ROUGH, MOVE_SUPER_FANG, MOVE_YAWN},
    .species = SPECIES_MIGHTYENA,
    .heldItem = ITEM_WEAKNESS_POLICY,
    .ability = ABILITY_INTIMIDATE,
    .lvl = 44,
    ...
    {
    .moves = {MOVE_SUCKER_PUNCH, MOVE_SEED_BOMB, MOVE_EXTRASENSORY, MOVE_SUBSTITUTE},
    ...
    {
    .moves = {MOVE_BEAT_UP, MOVE_INFERNO, MOVE_PSYCHIC_FANGS, MOVE_TORMENT},
    ...
    {
    .moves = {MOVE_KNOCK_OFF, MOVE_CRABHAMMER, MOVE_REVENGE, MOVE_TAUNT},
    .species = SPECIES_CRAWDAUNT,
    .heldItem = ITEM_RED_CARD,
    .ability = ABILITY_ADAPTABILITY,
    .lvl = 45,
    ...
    {
    .moves = {MOVE_NIGHT_SLASH, MOVE_PSYCHO_CUT, MOVE_CLOSE_COMBAT, MOVE_ME_FIRST},
...
static const struct TrainerMon sParty_Phoebe[] = {
    {
    .moves = {MOVE_SHADOW_PUNCH, MOVE_POISON_JAB, MOVE_ICE_PUNCH, MOVE_ENCORE},
    .species = SPECIES_GENGAR,
    ...
    {
    .moves = {MOVE_PHANTOM_FORCE, MOVE_FOUL_PLAY, MOVE_TRICK_ROOM, MOVE_DISABLE},
    .species = SPECIES_BANETTE,
    .heldItem = ITEM_METRONOME,
    ...
    {
    .moves = {MOVE_SHADOW_BALL, MOVE_MYSTICAL_FIRE, MOVE_DRAINING_KISS, MOVE_WILL_O_WISP},
    ...
    {
    .moves = {MOVE_SHADOW_SNEAK, MOVE_SUCKER_PUNCH, MOVE_TRICK, MOVE_SKILL_SWAP},
    .species = SPECIES_SABLEYE,
    ...
    {
    .moves = {MOVE_POLTERGEIST, MOVE_EARTHQUAKE, MOVE_ROCK_TOMB, MOVE_PAIN_SPLIT},
...
static const struct TrainerMon sParty_Glacia[] = {
    {
    .moves = {MOVE_FREEZE_DRY, MOVE_MOONBLAST, MOVE_PSYSHOCK, MOVE_GRUDGE},
    .species = SPECIES_NINETALES_ALOLAN,
    .heldItem = ITEM_ICY_ROCK,
    .ability = ABILITY_SNOW_WARNING,
    .lvl = 46,
    ...
    {
    .moves = {MOVE_ICICLE_CRASH, MOVE_PAYBACK, MOVE_FRUSTRATION, MOVE_EXPLOSION},
    .species = SPECIES_GLALIE,
    ...
    {
    .moves = {MOVE_BLIZZARD, MOVE_PSYCHIC, MOVE_DRAINING_KISS, MOVE_LOVELY_KISS},
    .species = SPECIES_JYNX,
    .heldItem = ITEM_METRONOME,
    .ability = ABILITY_OBLIVIOUS,
    .lvl = 47,
    ...
    {
    .moves = {MOVE_FROST_BREATH, MOVE_OMINOUS_WIND, MOVE_WATER_PULSE, MOVE_CONFUSE_RAY},
    .species = SPECIES_FROSLASS,
    .heldItem = ITEM_BRIGHT_POWDER,
    .ability = ABILITY_SNOW_CLOAK,
    .lvl = 47,
    ...
    {
    .moves = {MOVE_ICE_SHARD, MOVE_PURSUIT, MOVE_LOW_KICK, MOVE_DOUBLE_TEAM},
    .species = SPECIES_WEAVILE,
    .heldItem = ITEM_FOCUS_SASH,
    .ability = ABILITY_PRESSURE,
    .lvl = 48,
...
static const struct TrainerMon sParty_Drake[] = {
    {
    .moves = {MOVE_DRAGON_TAIL, MOVE_FLIP_TURN, MOVE_BOUNCE, MOVE_FLAIL},
    ...
    {
    .moves = {MOVE_BREAKING_SWIPE, MOVE_FLAME_CHARGE, MOVE_HURRICANE, MOVE_EARTHQUAKE},
    .species = SPECIES_CHARIZARD,
    ...
    {
    .moves = {MOVE_DRAGON_PULSE, MOVE_HYDRO_PUMP, MOVE_FLASH_CANNON, MOVE_DRAGON_DANCE},
    ...
    {
    .moves = {MOVE_DRAGON_CLAW, MOVE_LEAF_BLADE, MOVE_SEISMIC_TOSS, MOVE_SWORDS_DANCE},
    ...
    {
    .moves = {MOVE_DRAGON_RUSH, MOVE_AIR_SLASH, MOVE_STONE_EDGE, MOVE_FOCUS_ENERGY},
...
static const struct TrainerMon sParty_Roxanne1[] = {
    {
    .moves = {MOVE_ROCK_THROW, MOVE_WATER_GUN, MOVE_WRING_OUT, MOVE_WITHDRAW},
    ...
    {
    .moves = {MOVE_ROCK_THROW, MOVE_AQUA_JET, MOVE_ABSORB, MOVE_HARDEN},
    ...
    {
    .moves = {MOVE_ROCK_TOMB, MOVE_WHIRLPOOL, MOVE_FLAIL, MOVE_AMNESIA},
...
static const struct TrainerMon sParty_Brawly1[] = {
    {
    .moves = {MOVE_ROCK_SMASH, MOVE_CONFUSION, MOVE_FAKE_OUT, MOVE_BULK_UP},
    ...
    {
    .moves = {MOVE_ROCK_SMASH, MOVE_FEINT_ATTACK, MOVE_FEINT, MOVE_BULK_UP},
    .species = SPECIES_MAKUHITA,
    ...
    {
    .moves = {MOVE_TRIPLE_KICK, MOVE_PURSUIT, MOVE_RAPID_SPIN, MOVE_BULK_UP},
...
static const struct TrainerMon sParty_Wattson1[] = {
    {
    .moves = {MOVE_SHOCK_WAVE, MOVE_QUICK_ATTACK, MOVE_FIRE_FANG, MOVE_ROAR},
    .species = SPECIES_ELECTRIKE,
    ...
    {
    .moves = {MOVE_SHOCK_WAVE, MOVE_BODY_SLAM, MOVE_IRON_TAIL, MOVE_CHARGE},
    ...
    {
    .moves = {MOVE_THUNDERBOLT, MOVE_QUICK_ATTACK, MOVE_GRASS_KNOT, MOVE_NUZZLE},
    .species = SPECIES_RAICHU,
    ...
    {
    .moves = {MOVE_THUNDERBOLT, MOVE_BODY_SLAM, MOVE_ICE_PUNCH, MOVE_COUNTER},
    .species = SPECIES_ELECTABUZZ,
    .heldItem = ITEM_LIFE_ORB,
    .ability = ABILITY_STATIC,
    .lvl = 20,
...
static const struct TrainerMon sParty_Flannery1[] = {
    {
    .moves = {MOVE_OVERHEAT, MOVE_BODY_SLAM, MOVE_THUNDER_PUNCH, MOVE_SUNNY_DAY},
    ...
    {
    .moves = {MOVE_OVERHEAT, MOVE_SOLAR_BEAM, MOVE_ROCK_TOMB, MOVE_SMOKESCREEN},
    ...
    {
    .moves = {MOVE_FIRE_BLAST, MOVE_ANCIENT_POWER, MOVE_EARTH_POWER, MOVE_SHELL_SMASH},
    ...
    {
    .moves = {MOVE_FIRE_BLAST, MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_EXPLOSION},
...
static const struct TrainerMon sParty_Norman1[] = {
    {
    .moves = {MOVE_FACADE, MOVE_PURSUIT, MOVE_X_SCISSOR, MOVE_SWORDS_DANCE},
    .species = SPECIES_ZANGOOSE,
    ...
    {
    .moves = {MOVE_FACADE, MOVE_FEINT_ATTACK, MOVE_AERIAL_ACE, MOVE_SWORDS_DANCE},
    ...
    {
    .moves = {MOVE_RETALIATE, MOVE_SUCKER_PUNCH, MOVE_NONE, MOVE_NONE},
    ...
    {
    .moves = {MOVE_DOUBLE_EDGE, MOVE_CRUNCH, MOVE_HEAVY_SLAM, MOVE_BELLY_DRUM},
...
static const struct TrainerMon sParty_Winona1[] = {
    {
    .moves = {MOVE_CROSS_POISON, MOVE_ACROBATICS, MOVE_SUPER_FANG, MOVE_TAUNT},
    .species = SPECIES_CROBAT,
    ...
    {
    .moves = {MOVE_DOUBLE_EDGE, MOVE_BRAVE_BIRD, MOVE_REVERSAL, MOVE_AGILITY},
    ...
    {
    .moves = {MOVE_DRACO_METEOR, MOVE_HURRICANE, MOVE_EARTHQUAKE, MOVE_ROOST},
    ...
    {
    .moves = {MOVE_STEEL_WING, MOVE_DRILL_PECK, MOVE_ROCK_TOMB, MOVE_SWORDS_DANCE},
    .species = SPECIES_SKARMORY,
    ...
    {
    .moves = {MOVE_LEECH_LIFE, MOVE_AERIAL_ACE, MOVE_GIGA_DRAIN, MOVE_DOUBLE_TEAM},
...
static const struct TrainerMon sParty_TateAndLiza1[] = {
    {
    .moves = {MOVE_STONE_EDGE, MOVE_FUTURE_SIGHT, MOVE_MOONBLAST, MOVE_REFLECT},
    .species = SPECIES_LUNATONE,
    ...
    {
    .moves = {MOVE_STONE_EDGE, MOVE_FUTURE_SIGHT, MOVE_FLARE_BLITZ, MOVE_LIGHT_SCREEN},
    .species = SPECIES_SOLROCK,
    .heldItem = ITEM_LIGHT_CLAY,
    .ability = ABILITY_LEVITATE,
    .lvl = 39,
    ...
    {
    .moves = {MOVE_SHELL_SIDE_ARM, MOVE_PSYSHOCK, MOVE_FOUL_PLAY, MOVE_CALM_MIND},
    ...
    {
    .moves = {MOVE_EERIE_SPELL, MOVE_PSYCHIC, MOVE_SNARL, MOVE_CALM_MIND},
...
static const struct TrainerMon sParty_Juan1[] = {
    {
    .moves = {MOVE_DIVE, MOVE_BOUNCE, MOVE_BULLDOZE, MOVE_AQUA_RING},
    ...
    {
    .moves = {MOVE_WATERFALL, MOVE_ICICLE_SPEAR, MOVE_ROCK_BLAST, MOVE_SHELL_SMASH},
    .species = SPECIES_CLOYSTER,
    .heldItem = ITEM_MYSTIC_WATER,
    ...
    {
    .moves = {MOVE_SURF, MOVE_ICE_BEAM, MOVE_THUNDER, MOVE_SING},
    ...
    {
    .moves = {MOVE_AQUA_TAIL, MOVE_ICE_SHARD, MOVE_SIGNAL_BEAM, MOVE_RAIN_DANCE},
    ...
    {
    .moves = {MOVE_WATER_PULSE, MOVE_BLIZZARD, MOVE_CRUNCH, MOVE_HAIL},
...
static const struct TrainerMon sParty_Ted[] = {
    {
    .moves = {MOVE_FELL_STINGER, MOVE_POISON_STING, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Paul[] = {
    ...
    {
    .moves = {MOVE_BULLET_SEED, MOVE_SUNNY_DAY, MOVE_NONE, MOVE_NONE},
    ...
    {
    .moves = {MOVE_STRUGGLE_BUG, MOVE_POISON_STING, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Georgia[] = {
    {
    .moves = {MOVE_SLEEP_POWDER, MOVE_GUST, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Victor[] = {
    {
    .moves = {MOVE_COVET, MOVE_QUICK_ATTACK, MOVE_NONE, MOVE_NONE},
    ...
    {
    .moves = {MOVE_DRAINING_KISS, MOVE_QUICK_ATTACK, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Victoria[] = {
    {
    .moves = {MOVE_MAGICAL_LEAF, MOVE_SUNNY_DAY, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Vicky[] = {
    {
    .moves = {MOVE_WATER_PULSE, MOVE_YAWN, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Josh[] = {
    {
    .moves = {MOVE_BIDE, MOVE_CHARGE, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_GEODUDE_ALOLAN,
    .heldItem = ITEM_FOCUS_SASH,
    .ability = ABILITY_GALVANIZE,
    .lvl = 8,
...
static const struct TrainerMon sParty_Tommy[] = {
    {
    .moves = {MOVE_MIMIC, MOVE_COPYCAT, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Ben[] = {
    {
    .moves = {MOVE_VOLT_SWITCH, MOVE_THUNDER_WAVE, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Eddie[] = {
    {
    .moves = {MOVE_THUNDER_PUNCH, MOVE_SEISMIC_TOSS, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_PICHU,
    ...
    {
    .moves = {MOVE_FIRE_PUNCH, MOVE_SEISMIC_TOSS, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Wallace[] = {
    {
    .moves = {MOVE_MOONBLAST, MOVE_PSYCHIC, MOVE_MYSTICAL_FIRE, MOVE_MISTY_TERRAIN},
    .species = SPECIES_SYLVEON,
    ...
    {
    .moves = {MOVE_PLAY_ROUGH, MOVE_PSYCHO_CUT, MOVE_DRILL_RUN, MOVE_REST},
    .species = SPECIES_RAPIDASH_GALARIAN,
    ...
    {
    .moves = {MOVE_ICE_BEAM, MOVE_THUNDERBOLT, MOVE_FLAMETHROWER, MOVE_SOFT_BOILED},
    ...
    {
    .moves = {MOVE_DRAINING_KISS, MOVE_DRAIN_PUNCH, MOVE_COUNTER, MOVE_ENCORE},
    ...
    {
    .moves = {MOVE_DAZZLING_GLEAM, MOVE_AIR_SLASH, MOVE_TRI_ATTACK, MOVE_ROOST},
    ...
    {
    .moves = {MOVE_HYPER_VOICE, MOVE_FUTURE_SIGHT, MOVE_SHADOW_BALL, MOVE_HEAL_PULSE},
...
static const struct TrainerMon sParty_Jared[] = {
    {
    .moves = {MOVE_FRUSTRATION, MOVE_DRILL_PECK, MOVE_NONE, MOVE_NONE},
    ...
    {
    .moves = {MOVE_THRASH, MOVE_DRILL_RUN, MOVE_NONE, MOVE_NONE},
    ...
    {
    .moves = {MOVE_BUG_BITE, MOVE_AERIAL_ACE, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Humberto[] = {
    {
    .moves = {MOVE_CLOSE_COMBAT, MOVE_BRAVE_BIRD, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Edwardo[] = {
    {
    .moves = {MOVE_SWAGGER, MOVE_FLY, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Benny[] = {
    {
    .moves = {MOVE_QUICK_ATTACK, MOVE_TAILWIND, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_PIDGEOTTO,
    .heldItem = ITEM_QUICK_CLAW,
    .ability = ABILITY_KEEN_EYE,
    .lvl = 31,
    ...
    {
    .moves = {MOVE_RAZOR_WIND, MOVE_AIR_CUTTER, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_FEAROW,
    .heldItem = ITEM_RAZOR_CLAW,
    .ability = ABILITY_KEEN_EYE,
    .lvl = 31,
    ...
    {
    .moves = {MOVE_ZEN_HEADBUTT, MOVE_AIR_SLASH, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_NOCTOWL,
    .heldItem = ITEM_RAZOR_FANG,
    .ability = ABILITY_KEEN_EYE,
    .lvl = 31,
...
static const struct TrainerMon sParty_Jocelyn[] = {
    {
    .moves = {MOVE_FEINT_ATTACK, MOVE_ICY_WIND, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Laura[] = {
    {
    .moves = {MOVE_MEGA_DRAIN, MOVE_LEECH_SEED, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_SHROOMISH,
    .heldItem = ITEM_TOXIC_ORB,
...
static const struct TrainerMon sParty_Cora[] = {
    {
    .moves = {MOVE_COMET_PUNCH, MOVE_MACH_PUNCH, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_LEDIAN,
    .heldItem = ITEM_LOADED_DICE,
...
static const struct TrainerMon sParty_Paula[] = {
    {
    .moves = {MOVE_POUNCE, MOVE_SKY_UPPERCUT, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Martha[] = {
    {
    .moves = {MOVE_PAY_DAY, MOVE_DIG, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_MEOWTH,
...
static const struct TrainerMon sParty_GinaAndMiaUnused[] = {
    {
    //.postGame
    }
};
...
static const struct TrainerMon sParty_Dwayne[] = {
    {
    .moves = {MOVE_NUZZLE, MOVE_DOUBLE_KICK, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_PIKACHU,
    .heldItem = ITEM_QUICK_CLAW,
    .ability = ABILITY_STATIC,
    .lvl = 16,
    ...
    {
    .moves = {MOVE_KARATE_CHOP, MOVE_DUAL_CHOP, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_MACHOP,
    .heldItem = ITEM_RAZOR_CLAW,
    ...
    {
    .moves = {MOVE_WATER_PULSE, MOVE_MUD_BOMB, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Annika[] = {
    {
    .moves = {MOVE_AQUA_TAIL, MOVE_DRAGON_TAIL, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_GYARADOS,
    .heldItem = ITEM_ROCKY_HELMET,
    .ability = ABILITY_INTIMIDATE,
    .lvl = 42,
...
static const struct TrainerMon sParty_TabithaMossdeep[] = {
    {
    .moves = {MOVE_CRUNCH, MOVE_INFERNO, MOVE_SUPER_FANG, MOVE_NASTY_PLOT},
    .species = SPECIES_HOUNDOOM,
    .heldItem = ITEM_RAZOR_FANG,
    .ability = ABILITY_UNNERVE,
    .lvl = 40,
    ...
    {
    .moves = {MOVE_FLAMETHROWER, MOVE_THUNDER_FANG, MOVE_EXTREME_SPEED, MOVE_ROAR},
    .species = SPECIES_ARCANINE,
    .heldItem = ITEM_RAZOR_FANG,
    .ability = ABILITY_INTIMIDATE,
    .lvl = 42,
    ...
    {
    .moves = {MOVE_POISON_JAB, MOVE_EARTHQUAKE, MOVE_CHIP_AWAY, MOVE_FOCUS_ENERGY},
...
static const struct TrainerMon sParty_WallyVR1[] = {
    {
    .moves = {MOVE_EXPANDING_FORCE, MOVE_DAZZLING_GLEAM, MOVE_POWER_GEM, MOVE_PSYCHIC_TERRAIN},
    ...
    {
    .moves = {MOVE_FRENZY_PLANT, MOVE_HYPER_BEAM, MOVE_STOMPING_TANTRUM, MOVE_SYNTHESIS},
    ...
    {
    .moves = {MOVE_TRI_ATTACK, MOVE_PSYSHOCK, MOVE_SHADOW_BALL, MOVE_RECOVER},
    ...
    {
    .moves = {MOVE_SCALE_SHOT, MOVE_AQUA_TAIL, MOVE_EXTREME_SPEED, MOVE_DRAGON_DANCE},
    .species = SPECIES_DRAGONAIR,
    .heldItem = ITEM_WIDE_LENS,
...
static const struct TrainerMon sParty_BrendanRoute119Mudkip[] = {
    ...
    {
    .moves = {MOVE_RAZOR_SHELL, MOVE_ICICLE_SPEAR, MOVE_SWIFT, MOVE_SUPERSONIC},
    .species = SPECIES_CLOYSTER,
    .heldItem = ITEM_BERRY_JUICE,
    ...
    {
    .moves = {MOVE_LEAF_BLADE, MOVE_PURSUIT, MOVE_FURY_CUTTER, MOVE_AGILITY},
    .species = SPECIES_GROVYLE,
    .heldItem = ITEM_SITRUS_BERRY,
    .ability = ABILITY_OVERGROW,
    .lvl = 34,
...
static const struct TrainerMon sParty_MayRoute110Mudkip[] = {
    {
    .moves = {MOVE_FIRE_SPIN, MOVE_PAYBACK, MOVE_QUICK_ATTACK, MOVE_CONFUSE_RAY},
    .species = SPECIES_VULPIX,
    .heldItem = ITEM_ORAN_BERRY,
    .ability = ABILITY_FLASH_FIRE,
    .lvl = 18,
    ...
    {
    .moves = {MOVE_BUBBLE_BEAM, MOVE_PSYWAVE, MOVE_RAPID_SPIN, MOVE_HARDEN},
...
static const struct TrainerMon sParty_MayRoute119Mudkip[] = {
    {
    .moves = {MOVE_FIRE_SPIN, MOVE_PAYBACK, MOVE_HEX, MOVE_WILL_O_WISP},
    .species = SPECIES_VULPIX,
    .heldItem = ITEM_ORAN_BERRY,
    .ability = ABILITY_FLASH_FIRE,
    .lvl = 32,
    ...
    {
    .moves = {MOVE_BUBBLE_BEAM, MOVE_PSYWAVE, MOVE_GYRO_BALL, MOVE_RECOVER},
    .species = SPECIES_STARMIE,
    .heldItem = ITEM_BERRY_JUICE,
    .ability = ABILITY_ANALYTIC,
    .lvl = 33,
...
static const struct TrainerMon sParty_MayRoute110Treecko[] = {
    ...
    {
    .moves = {MOVE_MEGA_DRAIN, MOVE_POISON_STING, MOVE_CUT, MOVE_GROWTH},
    .species = SPECIES_ROSELIA,
    .heldItem = ITEM_ORAN_BERRY,
...
static const struct TrainerMon sParty_MayRoute119Treecko[] = {
    {
    .moves = {MOVE_BUBBLE_BEAM, MOVE_PSYWAVE, MOVE_RAPID_SPIN, MOVE_RECOVER},
    .species = SPECIES_STARYU,
    .heldItem = ITEM_ORAN_BERRY,
    .ability = ABILITY_NATURAL_CURE,
    .lvl = 32,
    ...
    {
    .moves = {MOVE_MEGA_DRAIN, MOVE_SLUDGE_BOMB, MOVE_CUT, MOVE_GRASS_WHISTLE},
...
static const struct TrainerMon sParty_MayRoute119Torchic[] = {
    {
    .moves = {MOVE_MEGA_DRAIN, MOVE_POISON_STING, MOVE_CUT, MOVE_GRASS_WHISTLE},
    .species = SPECIES_ROSELIA,
    .heldItem = ITEM_ORAN_BERRY,
    .ability = ABILITY_POISON_POINT,
    .lvl = 32,
    ...
    {
    .moves = {MOVE_FLAME_BURST, MOVE_PAYBACK, MOVE_HEX, MOVE_WILL_O_WISP},
    .species = SPECIES_NINETALES,
    .heldItem = ITEM_BERRY_JUICE,
    .ability = ABILITY_DROUGHT,
    .lvl = 33,
...
static const struct TrainerMon sParty_Sebastian[] = {
    {
    .moves = {MOVE_SOLAR_BEAM, MOVE_SUNNY_DAY, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Sophia[] = {
    {
    .moves = {MOVE_WEATHER_BALL, MOVE_RAIN_DANCE, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_ROSELIA,
    .heldItem = ITEM_DAMP_ROCK,
    .ability = ABILITY_NATURAL_CURE,
    .lvl = 32,
    ...
    {
    .moves = {MOVE_WEATHER_BALL, MOVE_AQUA_RING, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_PELIPPER,
    .heldItem = ITEM_LEFTOVERS,
    .ability = ABILITY_RAIN_DISH,
    .lvl = 32,
...
static const struct TrainerMon sParty_GruntSeafloorCavern5[] = {
    {
    .moves = {MOVE_AVALANCHE, MOVE_BRINE, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_WALREIN,
    .heldItem = ITEM_BRIGHT_POWDER,
    .ability = ABILITY_OBLIVIOUS,
    .lvl = 42,
    ...
    {
    .moves = {MOVE_DIVE, MOVE_BOUNCE, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_GYARADOS,
    .heldItem = ITEM_BRIGHT_POWDER,
    .ability = ABILITY_INTIMIDATE,
    .lvl = 42,
...
static const struct TrainerMon sParty_GruntMtPyre4[] = {
    {
    .moves = {MOVE_CURSE, MOVE_GRUDGE, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_DUSCLOPS,
    .heldItem = ITEM_BRIGHT_POWDER,
    .ability = ABILITY_PRESSURE,
    .lvl = 37,
...
static const struct TrainerMon sParty_GruntJaggedPass[] = {
    {
    .moves = {MOVE_ROCK_SLIDE, MOVE_POWER_UP_PUNCH, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_SUDOWOODO,
    .heldItem = ITEM_RAZOR_FANG,
    .ability = ABILITY_RATTLED,
    .lvl = 37,
    ...
    {
    .moves = {MOVE_NEEDLE_ARM, MOVE_SUCKER_PUNCH, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Marc[] = {
    ...
    {
    .moves = {MOVE_ROCK_TOMB, MOVE_BULLDOZE, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Brenden[] = {
    {
    .moves = {MOVE_BUBBLE, MOVE_MUD_SLAP, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Lilith[] = {
    {
    .moves = {MOVE_VACUUM_WAVE, MOVE_UPPER_HAND, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Cristian[] = {
    {
    .moves = {MOVE_REVERSAL, MOVE_MEGA_PUNCH, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_MACHOP,
    .heldItem = ITEM_BLACK_BELT,
...
static const struct TrainerMon sParty_Sylvia[] = {
    {
    .moves = {MOVE_DREAM_EATER, MOVE_HYPNOSIS, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_GruntMtChimney2[] = {
    {
    .moves = {MOVE_INCINERATE, MOVE_ROCK_TOMB, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Kathleen[] = {
    {
    .moves = {MOVE_HEAT_WAVE, MOVE_SHADOW_BONE, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Clifford[] = {
    {
    .moves = {MOVE_DISCHARGE, MOVE_ELECTRIC_TERRAIN, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_LANTURN,
    .heldItem = ITEM_TERRAIN_EXTENDER,
...
static const struct TrainerMon sParty_Nicholas[] = {
    {
    .moves = {MOVE_COUNTER, MOVE_MIRROR_COAT, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_GruntSpaceCenter3[] = {
    {
    .moves = {MOVE_OVERHEAT, MOVE_EXPLOSION, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_MAGCARGO,
    .heldItem = ITEM_RAZOR_FANG,
    ...
    {
    .moves = {MOVE_ERUPTION, MOVE_EXPLOSION, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_CAMERUPT,
    .heldItem = ITEM_RAZOR_FANG,
    .ability = ABILITY_MAGMA_ARMOR,
    .lvl = 42,
...
static const struct TrainerMon sParty_GruntSpaceCenter4[] = {
    {
    .moves = {MOVE_EXPLOSION, MOVE_BELLY_DRUM, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_GruntSpaceCenter5[] = {
    {
    .moves = {MOVE_DIG, MOVE_DRAGON_TAIL, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_GruntSpaceCenter6[] = {
    {
    .moves = {MOVE_DIG, MOVE_ROOST, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_GruntSpaceCenter7[] = {
    {
    .moves = {MOVE_DESTINY_BOND, MOVE_SLUDGE_BOMB, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_GENGAR,
    .heldItem = ITEM_RAZOR_FANG,
    .ability = ABILITY_CURSED_BODY,
    .lvl = 43,
...
static const struct TrainerMon sParty_Macey[] = {
    {
    .moves = {MOVE_DISCHARGE, MOVE_PSYSHOCK, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_RAICHU_ALOLAN,
    .heldItem = ITEM_ASSAULT_VEST,
    .ability = ABILITY_SURGE_SURFER,
    .lvl = 38,
...
static const struct TrainerMon sParty_BrendanRustboroTreecko[] = {
    ...
    {
    .moves = {MOVE_EMBER, MOVE_PECK, MOVE_SAND_ATTACK, MOVE_NONE},
    .species = SPECIES_TORCHIC,
    .heldItem = ITEM_ORAN_BERRY,
    .ability = ABILITY_BLAZE,
    .lvl = 14,
...
static const struct TrainerMon sParty_GruntWeatherInstitute5[] = {
    {
    .moves = {MOVE_PARTING_SHOT, MOVE_FACADE, MOVE_NONE, MOVE_NONE},
    ...
    {
    .moves = {MOVE_FLIP_TURN, MOVE_ENDEAVOR, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_GOLDUCK,
    .heldItem = ITEM_BRIGHT_POWDER,
    .ability = ABILITY_CLOUD_NINE,
    .lvl = 32,
...
static const struct TrainerMon sParty_TabithaMtChimney[] = {
    {
    .moves = {MOVE_BITE, MOVE_EMBER, MOVE_SMOG, MOVE_HOWL},
    .species = SPECIES_HOUNDOUR,
    .heldItem = ITEM_RAZOR_FANG,
    .ability = ABILITY_UNNERVE,
    .lvl = 20,
    ...
    {
    .moves = {MOVE_POISON_STING, MOVE_DOUBLE_KICK, MOVE_FURY_ATTACK, MOVE_FOCUS_ENERGY},
...
static const struct TrainerMon sParty_MayRustboroMudkip[] = {
    {
    .moves = {MOVE_WATER_GUN, MOVE_RAPID_SPIN, MOVE_HARDEN, MOVE_NONE},
    .species = SPECIES_STARYU,
    .heldItem = ITEM_NONE,
    .ability = ABILITY_NATURAL_CURE,
    .lvl = 13,
...
static const struct TrainerMon sParty_MaxieMagmaHideout[] = {
    {
    .moves = {MOVE_SLUDGE_BOMB, MOVE_ASSURANCE, MOVE_DOUBLE_HIT, MOVE_SELF_DESTRUCT},
    ...
    {
    .moves = {MOVE_FIRE_PUNCH, MOVE_THUNDER_PUNCH, MOVE_FEINT_ATTACK, MOVE_CONFUSE_RAY},
...
static const struct TrainerMon sParty_MaxieMtChimney[] = {
    {
    .moves = {MOVE_SLUDGE, MOVE_ASSURANCE, MOVE_SELF_DESTRUCT, MOVE_SMOKESCREEN},
    .species = SPECIES_KOFFING,
    .heldItem = ITEM_RAZOR_FANG,
    .ability = ABILITY_STENCH,
    .lvl = 23,
    ...
    {
    .moves = {MOVE_FLAME_BURST, MOVE_SMOG, MOVE_FEINT_ATTACK, MOVE_SMOKESCREEN},
    .species = SPECIES_MAGMAR,
    .heldItem = ITEM_RAZOR_FANG,
    .ability = ABILITY_VITAL_SPIRIT,
    .lvl = 24,
    ...
    {
    .moves = {MOVE_BULLDOZE, MOVE_SMACK_DOWN, MOVE_STOMP, MOVE_SCARY_FACE},
...
static const struct TrainerMon sParty_Vivi[] = {
    {
    .moves = {MOVE_FIRE_FANG, MOVE_YAWN, MOVE_NONE, MOVE_NONE},
    ...
    {
    .moves = {MOVE_THUNDER_FANG, MOVE_YAWN, MOVE_NONE, MOVE_NONE},
    ...
    {
    .moves = {MOVE_ICE_FANG, MOVE_HAIL, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Sally[] = {
    {
    .moves = {MOVE_GRASSY_GLIDE, MOVE_PIN_MISSILE, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_BUDEW,
...
static const struct TrainerMon sParty_Robin[] = {
    {
    .moves = {MOVE_PLAY_ROUGH, MOVE_METRONOME, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_TOGEPI,
    ...
    {
    .moves = {MOVE_FLAIL, MOVE_BELLY_DRUM, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_MUNCHLAX,
...
static const struct TrainerMon sParty_Andrea[] = {
    {
    .moves = {MOVE_ICICLE_SPEAR, MOVE_HAIL, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Crissy[] = {
    {
    .moves = {MOVE_SURF, MOVE_SHELL_SMASH, MOVE_NONE, MOVE_NONE},
    ...
    {
    .moves = {MOVE_WATERFALL, MOVE_DRAGON_DANCE, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Alan[] = {
    {
    .moves = {MOVE_BULLDOZE, MOVE_ROCK_SMASH, MOVE_NONE, MOVE_NONE},
    ...
    {
    .moves = {MOVE_BULLDOZE, MOVE_ROCK_TOMB, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_RHYHORN,
    .heldItem = ITEM_SOFT_SAND,
    .ability = ABILITY_LIGHTNING_ROD,
    .lvl = 16,
...
static const struct TrainerMon sParty_Johanna[] = {
    {
    .moves = {MOVE_SAND_TOMB, MOVE_IRON_HEAD, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Gerald[] = {
    {
    .moves = {MOVE_LAVA_PLUME, MOVE_SEISMIC_TOSS, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_MAGMAR,
...
static const struct TrainerMon sParty_Vivian[] = {
    {
    .moves = {MOVE_THUNDER_PUNCH, MOVE_THUNDER_WAVE, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Danielle[] = {
    {
    .moves = {MOVE_FLAME_CHARGE, MOVE_DETECT, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_COMBUSKEN,
    .heldItem = ITEM_CHARCOAL,
    .ability = ABILITY_SPEED_BOOST,
    .lvl = 23,
...
static const struct TrainerMon sParty_Flint[] = {
    {
    .moves = {MOVE_X_SCISSOR, MOVE_DIG, MOVE_NONE, MOVE_NONE},
    ...
    {
    .moves = {MOVE_NIGHT_SLASH, MOVE_AIR_SLASH, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_HONCHKROW,
    .heldItem = ITEM_CLEAR_AMULET,
    .ability = ABILITY_MOXIE,
    .lvl = 32,
...
static const struct TrainerMon sParty_Ashley[] = {
    {
    .moves = {MOVE_DRAINING_KISS, MOVE_MIRROR_MOVE, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_TOGETIC,
    .heldItem = ITEM_SCOPE_LENS,
    .ability = ABILITY_SUPER_LUCK,
    .lvl = 31,
    ...
    {
    .moves = {MOVE_SEED_BOMB, MOVE_ACROBATICS, MOVE_NONE, MOVE_NONE},
    ...
    {
    .moves = {MOVE_GRASS_KNOT, MOVE_LOW_KICK, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_BRELOOM,
    .heldItem = ITEM_EXPERT_BELT,
    .ability = ABILITY_TECHNICIAN,
    .lvl = 31,
...
static const struct TrainerMon sParty_WallyMauville[] = {
    {
    .moves = {MOVE_SECRET_POWER, MOVE_DISCHARGE, MOVE_PSYBEAM, MOVE_RECOVER},
    ...
    {
    .moves = {MOVE_CONFUSION, MOVE_DISARMING_VOICE, MOVE_MAGICAL_LEAF, MOVE_DOUBLE_TEAM},
    .species = SPECIES_KIRLIA,
    .heldItem = ITEM_EVIOLITE,
...
static const struct TrainerMon sParty_BrendanLilycoveTreecko[] = {
    ...
    {
    .moves = {MOVE_WOOD_HAMMER, MOVE_PSYSHOCK, MOVE_EGG_BOMB, MOVE_SLEEP_POWDER},
    .species = SPECIES_EXEGGUTOR,
    .heldItem = ITEM_SITRUS_BERRY,
    .ability = ABILITY_HARVEST,
    .lvl = 38,
    ...
    {
    .moves = {MOVE_BLAZE_KICK, MOVE_HIGH_JUMP_KICK, MOVE_SLASH, MOVE_BULK_UP},
...
static const struct TrainerMon sParty_BrendanLilycoveTorchic[] = {
    ...
    {
    .moves = {MOVE_MUDDY_WATER, MOVE_MUD_BOMB, MOVE_HAMMER_ARM, MOVE_BIDE},
...
static const struct TrainerMon sParty_MayLilycoveMudkip[] = {
    {
    .moves = {MOVE_AIR_SLASH, MOVE_TAKE_DOWN, MOVE_EXTRASENSORY, MOVE_HYPNOSIS},
    .species = SPECIES_NOCTOWL,
    .heldItem = ITEM_BERRY_JUICE,
    .ability = ABILITY_TINTED_LENS,
    .lvl = 37,
    ...
    {
    .moves = {MOVE_FLAMETHROWER, MOVE_PAYBACK, MOVE_HEX, MOVE_WILL_O_WISP},
    .species = SPECIES_NINETALES,
    .heldItem = ITEM_SITRUS_BERRY,
    .ability = ABILITY_DROUGHT,
    .lvl = 38,
    ...
    {
    .moves = {MOVE_BRINE, MOVE_PSYWAVE, MOVE_GYRO_BALL, MOVE_RECOVER},
    .species = SPECIES_STARMIE,
    .heldItem = ITEM_SITRUS_BERRY,
    .ability = ABILITY_ANALYTIC,
    .lvl = 38,
...
static const struct TrainerMon sParty_MayLilycoveTreecko[] = {
    ...
    {
    .moves = {MOVE_MAGICAL_LEAF, MOVE_SLUDGE_BOMB, MOVE_FURY_CUTTER, MOVE_GRASSY_TERRAIN},
    .species = SPECIES_ROSERADE,
    .heldItem = ITEM_SITRUS_BERRY,
    .ability = ABILITY_TECHNICIAN,
    .lvl = 38,
...
static const struct TrainerMon sParty_GruntMagmaHideout1[] = {
    {
    .moves = {MOVE_ERUPTION, MOVE_YAWN, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_TORKOAL,
    .heldItem = ITEM_RAZOR_FANG,
    .ability = ABILITY_DROUGHT,
    .lvl = 38,
...
static const struct TrainerMon sParty_GruntMagmaHideout2[] = {
    {
    .moves = {MOVE_MAGNITUDE, MOVE_SELF_DESTRUCT, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_GRAVELER,
    .heldItem = ITEM_RAZOR_FANG,
    .ability = ABILITY_STURDY,
    .lvl = 38,
...
static const struct TrainerMon sParty_GruntMagmaHideout3[] = {
    {
    .moves = {MOVE_STOMPING_TANTRUM, MOVE_STONE_EDGE, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_RHYDON,
    .heldItem = ITEM_RAZOR_FANG,
    .ability = ABILITY_LIGHTNING_ROD,
    .lvl = 38,
...
static const struct TrainerMon sParty_GruntMagmaHideout4[] = {
    {
    .moves = {MOVE_SANDSTORM, MOVE_EARTHQUAKE, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_ONIX,
    .heldItem = ITEM_RAZOR_FANG,
    .ability = ABILITY_STURDY,
    .lvl = 37,
    ...
    {
    .moves = {MOVE_DIG, MOVE_TRI_ATTACK, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_GruntMagmaHideout5[] = {
    {
    .moves = {MOVE_FLAME_CHARGE, MOVE_SCORCHING_SANDS, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_MAGMAR,
    .heldItem = ITEM_RAZOR_FANG,
    .ability = ABILITY_FLAME_BODY,
    .lvl = 37,
    ...
    {
    .moves = {MOVE_HIGH_HORSEPOWER, MOVE_SANDSTORM, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_GruntMagmaHideout6[] = {
    {
    .moves = {MOVE_POISON_JAB, MOVE_DRILL_RUN, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_NIDOKING,
    .heldItem = ITEM_RAZOR_FANG,
    .ability = ABILITY_RIVALRY,
    .lvl = 38,
...
static const struct TrainerMon sParty_GruntMagmaHideout7[] = {
    {
    .moves = {MOVE_METAL_BURST, MOVE_ROCK_TOMB, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_LAIRON,
    .heldItem = ITEM_RAZOR_FANG,
    .ability = ABILITY_STURDY,
    .lvl = 38,
...
static const struct TrainerMon sParty_GruntMagmaHideout8[] = {
    {
    .moves = {MOVE_BULLDOZE, MOVE_COUNTER, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_GruntMagmaHideout9[] = {
    {
    .moves = {MOVE_BONEMERANG, MOVE_THUNDER_PUNCH, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_MAROWAK_ALOLAN,
    .heldItem = ITEM_RAZOR_FANG,
...
static const struct TrainerMon sParty_GruntMagmaHideout10[] = {
    {
    .moves = {MOVE_FIRE_PUNCH, MOVE_SHADOW_BONE, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_MAROWAK_ALOLAN,
    .heldItem = ITEM_RAZOR_FANG,
    .ability = ABILITY_CURSED_BODY,
    .lvl = 38,
...
static const struct TrainerMon sParty_GruntMagmaHideout11[] = {
    {
    .moves = {MOVE_LASH_OUT, MOVE_BURNING_JEALOUSY, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_HOUNDOOM,
    .heldItem = ITEM_RAZOR_FANG,
    .ability = ABILITY_UNNERVE,
    .lvl = 38,
...
static const struct TrainerMon sParty_GruntMagmaHideout12[] = {
    {
    .moves = {MOVE_RAGING_FURY, MOVE_OUTRAGE, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_ARCANINE,
    .heldItem = ITEM_RAZOR_FANG,
    .ability = ABILITY_INTIMIDATE,
    .lvl = 38,
...
static const struct TrainerMon sParty_GruntMagmaHideout13[] = {
    {
    .moves = {MOVE_HEAT_CRASH, MOVE_HEAD_SMASH, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_GruntMagmaHideout14[] = {
    {
    .moves = {MOVE_EARTH_POWER, MOVE_EXTRASENSORY, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_GruntMagmaHideout16[] = {
    {
    .moves = {MOVE_GRUDGE, MOVE_GUNK_SHOT, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_TabithaMagmaHideout[] = {
    {
    .moves = {MOVE_MEGAHORN, MOVE_DOUBLE_KICK, MOVE_HORN_ATTACK, MOVE_FOCUS_ENERGY},
    .species = SPECIES_NIDORINO,
    .heldItem = ITEM_RAZOR_FANG,
    .ability = ABILITY_HUSTLE,
    .lvl = 35,
    ...
    {
    .moves = {MOVE_BITE, MOVE_INFERNO, MOVE_SMOG, MOVE_HOWL},
    .species = SPECIES_HOUNDOOM,
    .heldItem = ITEM_RAZOR_FANG,
    .ability = ABILITY_UNNERVE,
    .lvl = 37,
    ...
    {
    .moves = {MOVE_FIRE_FANG, MOVE_THUNDER_FANG, MOVE_RETALIATE, MOVE_ROAR},
    .species = SPECIES_ARCANINE,
    .heldItem = ITEM_RAZOR_FANG,
    .ability = ABILITY_INTIMIDATE,
    .lvl = 39,
...
static const struct TrainerMon sParty_MaxieMossdeep[] = {
    {
    .moves = {MOVE_SLUDGE_BOMB, MOVE_ASSURANCE, MOVE_GYRO_BALL, MOVE_EXPLOSION},
    .species = SPECIES_WEEZING,
    .heldItem = ITEM_RAZOR_FANG,
    .ability = ABILITY_STENCH,
    .lvl = 43,
    ...
    {
    .moves = {MOVE_FIRE_BLAST, MOVE_THUNDER_PUNCH, MOVE_LOW_KICK, MOVE_WILL_O_WISP},
    ...
    {
    .moves = {MOVE_DRILL_RUN, MOVE_STONE_EDGE, MOVE_DOUBLE_EDGE, MOVE_PROTECT},
...
static const struct TrainerMon sParty_MayRustboroTreecko[] = {
    {
    .moves = {MOVE_MEGA_DRAIN, MOVE_POISON_STING, MOVE_STUN_SPORE, MOVE_NONE},
    .species = SPECIES_ROSELIA,
    .heldItem = ITEM_NONE,
    .ability = ABILITY_POISON_POINT,
    .lvl = 13,
...
static const struct TrainerMon sParty_MayRustboroTorchic[] = {
    {
    .moves = {MOVE_EMBER, MOVE_QUICK_ATTACK, MOVE_CONFUSE_RAY, MOVE_NONE},
    .species = SPECIES_VULPIX,
    .heldItem = ITEM_NONE,
    .ability = ABILITY_FLASH_FIRE,
    .lvl = 13,
...
static const struct TrainerMon sParty_Angelo[] = {
    {
    .moves = {MOVE_CHARGE_BEAM, MOVE_THUNDER_WAVE, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_ILLUMISE,
...
static const struct TrainerMon sParty_Darius[] = {
    {
    .moves = {MOVE_GIGA_DRAIN, MOVE_ROOST, MOVE_NONE, MOVE_NONE},
...
static const struct TrainerMon sParty_Steven[] = {
    {
    .moves = {MOVE_STEEL_WING, MOVE_AIR_SLASH, MOVE_SANDSTORM, MOVE_STEALTH_ROCK},
    .species = SPECIES_SKARMORY,
    .heldItem = ITEM_CUSTAP_BERRY,
    .ability = ABILITY_STURDY,
    .lvl = 54,
    ...
    {
    .moves = {MOVE_DOOM_DESIRE, MOVE_FUTURE_SIGHT, MOVE_WISH, MOVE_PROTECT},
    ...
    {
    .moves = {MOVE_HEAVY_SLAM, MOVE_STONE_EDGE, MOVE_SUPERPOWER, MOVE_ROCK_POLISH},
    ...
    {
    .moves = {MOVE_GYRO_BALL, MOVE_EARTHQUAKE, MOVE_HEAD_SMASH, MOVE_DRAGON_TAIL},
    .species = SPECIES_STEELIX,
    .heldItem = ITEM_IRON_BALL,
    .ability = ABILITY_ROCK_HEAD,
    .lvl = 53,
    ...
    {
    .moves = {MOVE_BUG_BITE, MOVE_BULLET_PUNCH, MOVE_CLOSE_COMBAT, MOVE_SWORDS_DANCE},
    ...
    {
    .moves = {MOVE_STEEL_BEAM, MOVE_ZEN_HEADBUTT, MOVE_METEOR_BEAM, MOVE_IRON_DEFENSE},
...
static const struct TrainerMon sParty_Mariela[] = {
    {
    .moves = {MOVE_MIRROR_COAT, MOVE_COUNTER, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_WOBBUFFET,
    .heldItem = ITEM_ENIGMA_BERRY,
    .ability = ABILITY_SHADOW_TAG,
    .lvl = 38,
...
static const struct TrainerMon sParty_Alvaro[] = {
    {
    .moves = {MOVE_PHANTOM_FORCE, MOVE_DESTINY_BOND, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_BANETTE,
    .heldItem = ITEM_SPELL_TAG,
    .ability = ABILITY_CURSED_BODY,
    .lvl = 37,
    ...
    {
    .moves = {MOVE_PSYCHIC, MOVE_RECOVER, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_ALAKAZAM,
    .heldItem = ITEM_LIFE_ORB,
    .ability = ABILITY_SYNCHRONIZE,
    .lvl = 37,
...
static const struct TrainerMon sParty_Everett[] = {
    {
    .moves = {MOVE_TAUNT, MOVE_SHADOW_SNEAK, MOVE_NONE, MOVE_NONE},
    .species = SPECIES_SABLEYE,
    .heldItem = ITEM_RED_CARD,
    .ability = ABILITY_PRANKSTER,
    .lvl = 38,
...
static const struct TrainerMon sParty_Red[] = {
    ...
    .moves = {MOVE_PIKA_PAPOW, MOVE_QUIVER_DANCE, MOVE_BATON_PASS, MOVE_REVIVAL_BLESSING},
    .species = SPECIES_PIKACHU_HERO,
    ...
    .ev = TRAINER_PARTY_EVS(252, 252, 252, 252, 252, 252),
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_SHADOW_BALL, MOVE_GUNK_SHOT, MOVE_NIGHT_SHADE, MOVE_CURSE},
    .species = SPECIES_GENGAR,
    .heldItem = ITEM_ENIGMA_BERRY,
    .ability = ABILITY_SHADOW_TAG,
    .lvl = 100,
    ...
    .ev = TRAINER_PARTY_EVS(252, 252, 252, 252, 252, 252),
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_FRENZY_PLANT, MOVE_POISON_JAB, MOVE_EARTHQUAKE, MOVE_SYNTHESIS},
    ...
    .ev = TRAINER_PARTY_EVS(252, 252, 252, 252, 252, 252),
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_BLAST_BURN, MOVE_DRAGON_RUSH, MOVE_SOLAR_BLADE, MOVE_MORNING_SUN},
    ...
    .ev = TRAINER_PARTY_EVS(252, 252, 252, 252, 252, 252),
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_HYDRO_CANNON, MOVE_BODY_PRESS, MOVE_CRUNCH, MOVE_SLACK_OFF},
    ...
    .ev = TRAINER_PARTY_EVS(252, 252, 252, 252, 252, 252),
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_PSYSTRIKE, MOVE_COUNTER, MOVE_RETURN, MOVE_RECOVER},
...
static const struct TrainerMon sParty_Leaf[] = {
    ...
    .ev = TRAINER_PARTY_EVS(252, 252, 252, 252, 252, 252),
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_VEEVEE_VOLLEY, MOVE_VICTORY_DANCE, MOVE_BATON_PASS, MOVE_REVIVAL_BLESSING},
    .species = SPECIES_EEVEE_HERO,
    .heldItem = ITEM_EVIOLITE,
    .ability = ABILITY_MOODY,
    .lvl = 100,
    .ball = ITEM_CHERISH_BALL,
    ...
    .ev = TRAINER_PARTY_EVS(252, 252, 252, 252, 252, 252),
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_PLAY_ROUGH, MOVE_FUTURE_SIGHT, MOVE_SEISMIC_TOSS, MOVE_HEALING_WISH},
    .species = SPECIES_CLEFABLE,
    .heldItem = ITEM_ENIGMA_BERRY,
    .ability = ABILITY_ARENA_TRAP,
    .lvl = 100,
    ...
    .ev = TRAINER_PARTY_EVS(252, 252, 252, 252, 252, 252),
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_FRENZY_PLANT, MOVE_SLUDGE_BOMB, MOVE_EARTH_POWER, MOVE_SYNTHESIS},
    .species = SPECIES_VENUSAUR_MEGA,
    .heldItem = ITEM_GRASSIUM_Z,
    .ability = ABILITY_PROTOSYNTHESIS,
    .lvl = 100,
    ...
    .ev = TRAINER_PARTY_EVS(252, 252, 252, 252, 252, 252),
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_BLAST_BURN, MOVE_AEROBLAST, MOVE_SOLAR_BEAM, MOVE_MORNING_SUN},
    ...
    .ev = TRAINER_PARTY_EVS(252, 252, 252, 252, 252, 252),
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_HYDRO_CANNON, MOVE_AURA_SPHERE, MOVE_DARK_PULSE, MOVE_SLACK_OFF},
    .species = SPECIES_BLASTOISE_MEGA,
    .heldItem = ITEM_WATERIUM_Z,
    .ability = ABILITY_ORICHALCUM_PULSE,
    .lvl = 100,
    ...
    .ev = TRAINER_PARTY_EVS(252, 252, 252, 252, 252, 252),
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .moves = {MOVE_PSYCHIC, MOVE_MIRROR_COAT, MOVE_RETURN, MOVE_RECOVER},
...
static const struct TrainerMon sParty_BrendanLinkPlaceholder[] = {
    {
    //.nickname = COMPOUND_STRING("Nickname"),
