...
const u8 gText_YouAlreadyHaveThis[] = _("You seem to already have this\nTM.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_BattleScene[] = _("Bat. Scene");
const u8 gText_EvoScene[] = _("Evo. Scene");
const u8 gText_Difficulty[] = _("Difficulty");
const u8 gText_Sound[] = _("Sound Type");
...
const u8 gText_DifficultyNorm[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Med");
...
const u8 gText_FrameStyle[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Style");
const u8 gText_FrameStyleNumber[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}");
