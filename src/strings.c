...
const u8 gText_BirchAdventure[] = _("ADVENTURE");
const u8 gText_BirchChallenge[] = _("CHALLENGE");
...
const u8 gText_NoMoreRoomForThis[] = _("You have no more room for this item.{PAUSE_UNTIL_PRESS}");
const u8 gText_YouAlreadyHaveThis[] = _("You seem to already have this TM.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_50CoinsAndPrice[] = _("50 COINS{CLEAR_TO 0x4B}  ¥1000");
const u8 gText_500CoinsAndPrice[] = _("500 COINS{CLEAR_TO 0x4B}¥10000");
...
const u8 gText_BerryJuice20[] = _("BERRY JUICE{CLEAR_TO 114}{FONT_SMALL}20");
const u8 gText_HPUp100[] = _("HP UP{CLEAR_TO 106}{FONT_SMALL}100");
const u8 gText_Protein100[] = _("PROTEIN{CLEAR_TO 106}{FONT_SMALL}100");
const u8 gText_Iron100[] = _("IRON{CLEAR_TO 106}{FONT_SMALL}100");
const u8 gText_Calcium100[] = _("CALCIUM{CLEAR_TO 106}{FONT_SMALL}100");
const u8 gText_Zinc100[] = _("ZINC{CLEAR_TO 106}{FONT_SMALL}100");
const u8 gText_Carbos100[] = _("CARBOS{CLEAR_TO 106}{FONT_SMALL}100");
const u8 gText_PPUp300[] = _("PP UP{CLEAR_TO 106}{FONT_SMALL}300");
const u8 gText_PPMax3000[] = _("PP MAX{CLEAR_TO 99}{FONT_SMALL}3000");
...
const u8 gText_ThatsYourLastPkmn[] = _("It won't go in the BOX!");
...
const u8 gText_OptionMenuTitle[] = _("OPTION");
const u8 gText_OptionMenuDifficulty[] = _("DIFFICULTY");
const u8 gText_OptionMenuBattleScene[] = _("BATTLE SCENE");
const u8 gText_OptionMenuExpShare[] = _("EXP. SHARE");
const u8 gText_OptionMenuMachoBrace[] = _("MACHO BRACE");
const u8 gText_OptionMenuEverstone[] = _("EVERSTONE");
const u8 gText_OptionMenuFrameType[] = _("FRAME TYPE");
const u8 gText_OptionMenuCancel[] = _("CANCEL");
const u8 gText_OptionMenuEasy[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}EASY");
const u8 gText_OptionMenuMed[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}MED");
const u8 gText_OptionMenuHard[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}HARD");
const u8 gText_OptionMenuOff[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}OFF");
const u8 gText_OptionMenuOn[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ON");
const u8 gText_OptionMenuNumber[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}");
...
// Trainer Tips
const u8 gText_TrainerTipsSave[] = _("SAVE");
const u8 gText_TrainerTipsRunning[] = _("RUNNING");
const u8 gText_TrainerTipsExperience[] = _("EXPERIENCE");
const u8 gText_TrainerTipsPP[] = _("PP");
const u8 gText_TrainerTipsDoubles[] = _("DOUBLES");
const u8 gText_TrainerTipsFishing[] = _("FISHING");
const u8 gText_TrainerTipsEffort[] = _("EFFORT");
const u8 gText_TrainerTipsStatus[] = _("STATUS");
const u8 gText_TrainerTipsReorganize[] = _("REORGANIZE");
const u8 gText_TrainerTipsStats[] = _("STATS");
const u8 gText_TrainerTipsRegister[] = _("REGISTER");
...
// Game Corner
const u8 gText_PorygonAndPrice[] = _("PORYGON{CLEAR_TO 0xFF}9999");
const u8 gText_DratiniAndPrice[] = _("DRATINI{CLEAR_TO 0xFF}9999");
const u8 gText_LarvitarAndPrice[] = _("LARVITAR{CLEAR_TO 0xFF}9999");
const u8 gText_BagonAndPrice[] = _("BAGON{CLEAR_TO 0xFF}9999");
const u8 gText_BeldumAndPrice[] = _("BELDUM{CLEAR_TO 0xFF}9999");
const u8 gText_GibleAndPrice[] = _("GIBLE{CLEAR_TO 0xFF}9999");
const u8 gText_DeinoAndPrice[] = _("DEINO{CLEAR_TO 0xFF}9999");
const u8 gText_GoomyAndPrice[] = _("GOOMY{CLEAR_TO 0xFF}9999");
const u8 gText_JangmoOAndPrice[] = _("JANGMO-O{CLEAR_TO 0xFF}9999");
const u8 gText_DreepyAndPrice[] = _("DREEPY{CLEAR_TO 0xFF}9999");
const u8 gText_FrigibaxAndPrice[] = _("FRIGIBAX{CLEAR_TO 0xFF}9999");
const u8 gText_GimmighoulCoinAndPrice[] = _("GIMMIGHOUL COIN{CLEAR_TO 0xFF}      1");
const u8 gText_LeekAndPrice[] = _("LEEK{CLEAR_TO 0xFF}    50");
const u8 gText_LightBallAndPrice[] = _("LIGHT BALL{CLEAR_TO 0xFF}    50");
const u8 gText_LuckyPunchAndPrice[] = _("LUCKY PUNCH{CLEAR_TO 0xFF}    50");
const u8 gText_MetalPowderAndPrice[] = _("METAL POWDER{CLEAR_TO 0xFF}    50");
const u8 gText_QuickPowderAndPrice[] = _("QUICK POWDER{CLEAR_TO 0xFF}    50");
const u8 gText_ThickClubAndPrice[] = _("THICK CLUB{CLEAR_TO 0xFF}    50");
const u8 gText_DragonScaleAndPrice[] = _("DRAGON SCALE{CLEAR_TO 0xFF}  100");
const u8 gText_PrismScaleAndPrice[] = _("PRISM SCALE{CLEAR_TO 0xFF}  100");
const u8 gText_DeepSeaScaleAndPrice[] = _("DEEP SEA SCALE{CLEAR_TO 0xFF}  100");
const u8 gText_DeepSeaToothAndPrice[] = _("DEAP SEA TOOTH{CLEAR_TO 0xFF}  100");
const u8 gText_LeadersCrestAndPrice[] = _("LEADERS CREST{CLEAR_TO 0xFF}  150");
const u8 gText_AmuletCoinAndPrice[] = _("AMULET COIN{CLEAR_TO 0xFF}  500");
const u8 gText_ExpShareAndPrice[] = _("EXP SHARE{CLEAR_TO 0xFF}  500");
const u8 gText_LuckyEggAndPrice[] = _("LUCKY EGG{CLEAR_TO 0xFF}  500");
const u8 gText_SweetAppleAndPrice[] = _("SWEET APPLE{CLEAR_TO 0xFF}  100");
const u8 gText_SyrupyAppleAndPrice[] = _("SYRUPY APPLE{CLEAR_TO 0xFF}  100");
const u8 gText_TartAppleAndPrice[] = _("TART APPLE{CLEAR_TO 0xFF}  100");
const u8 gText_CrackedPotAndPrice[] = _("CRACKED POT{CLEAR_TO 0xFF}  100");
const u8 gText_UnremarkableTeacupAndPrice[] = _("UNREMARKABLE TEACUP{CLEAR_TO 0xFF}  100");
const u8 gText_AuspiciousArmorAndPrice[] = _("AUSPICIOUS ARMOR{CLEAR_TO 0xFF}  150");
const u8 gText_MaliciousArmorAndPrice[] = _("MALICIOUS ARMOR{CLEAR_TO 0xFF}  150");
const u8 gText_GalaricaCuffAndPrice[] = _("GALARICA CUFF{CLEAR_TO 0xFF}  300");
const u8 gText_GalaricaWreathAndPrice[] = _("GALARICA WREATH{CLEAR_TO 0xFF}  300");
const u8 gText_BlackAuguriteAndPrice[] = _("BLACK AUGURITE{CLEAR_TO 0xFF}  400");
const u8 gText_LinkingCordAndPrice[] = _("LINKING CORD{CLEAR_TO 0xFF}  400");
const u8 gText_MetalAlloyAndPrice[] = _("METAL ALLOY{CLEAR_TO 0xFF}  500");
const u8 gText_PeatBlockAndPrice[] = _("PEAT BLOCK{CLEAR_TO 0xFF}  500");
const u8 gText_ChippedPotAndPrice[] = _("CHIPPED POT{CLEAR_TO 0xFF}2000");
const u8 gText_MasterpieceTeacupAndPrice[] = _("MASTERPIECE TEACUP{CLEAR_TO 0xFF}2000");
const u8 gText_BerrySweetAndPrice[] = _("BERRY SWEET{CLEAR_TO 0xFF}    50");
const u8 gText_CloverSweetAndPrice[] = _("CLOVER SWEET{CLEAR_TO 0xFF}    50");
const u8 gText_FlowerSweetAndPrice[] = _("FLOWER SWEET{CLEAR_TO 0xFF}    50");
const u8 gText_LoveSweetAndPrice[] = _("LOVE SWEET{CLEAR_TO 0xFF}    50");
const u8 gText_RibbonSweetAndPrice[] = _("RIBBON SWEET{CLEAR_TO 0xFF}    50");
const u8 gText_StarSweetAndPrice[] = _("STAR SWEET{CLEAR_TO 0xFF}    50");
const u8 gText_StrawberrySweetAndPrice[] = _("STRAWBERRY SWEET{CLEAR_TO 0xFF}    50");
const u8 gText_UpgradeAndPrice[] = _("UPGRADE{CLEAR_TO 0xFF}  100");
const u8 gText_DubiousDiscAndPrice[] = _("DUBIOUS DISC{CLEAR_TO 0xFF}  100");
const u8 gText_ElectirizerAndPrice[] = _("ELECTIRIZER{CLEAR_TO 0xFF}  100");
const u8 gText_MagmarizerAndPrice[] = _("MAGMARIZER{CLEAR_TO 0xFF}  100");
const u8 gText_ProtectorAndPrice[] = _("PROTECTOR{CLEAR_TO 0xFF}  100");
const u8 gText_ReaperClothAndPrice[] = _("REAPER CLOTH{CLEAR_TO 0xFF}  100");
const u8 gText_SachetAndPrice[] = _("SACHET{CLEAR_TO 0xFF}  100");
const u8 gText_WhippedDreamAndPrice[] = _("WHIPPED DREAM{CLEAR_TO 0xFF}  100");

// Cutting Hunter
const u8 gText_PinkApricorn[] = _("PINK APRICORN");
const u8 gText_RedApricorn[] = _("RED APRICORN");
const u8 gText_GreenApricorn[] = _("GREEN APRICORN");
const u8 gText_WhiteApricorn[] = _("WHITE APRICORN");
const u8 gText_BlueApricorn[] = _("BLUE APRICORN");
const u8 gText_YellowApricorn[] = _("YELLOW APRICORN");
const u8 gText_BlackApricorn[] = _("BLACK APRICORN");

// Smashing Hunter
const u8 gText_RareBone[] = _("RARE BONE");
const u8 gText_OddBone[] = _("ODD BONE");
...
const u8 gText_PrettyFeather[] = _("PRETTY FEATHER");

// Surfing Hunter
const u8 gText_ShoalShell[] = _("SHOAL SHELL");
const u8 gText_ShoalSalt[] = _("SHOAL SALT");
...
const u8 gText_Dawn_Stone[] = _("DAWN STONE");
